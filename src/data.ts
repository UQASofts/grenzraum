...
export const INITIAL_POIS: POI[] = [
  {
    ...
    deName: "Schwarzer See",
    deDescription: "Der größte Natursee der Tschechischen Republik, eingefasst von den dunklen Fichtenwäldern des Nationalparks Šumava. Der See wirkt tief schwarz durch die Spiegelung der Wälder und des dunklen Seebodens.",
  ...
  },
  {
    ...
    deName: "Klatovy Altstadt",
    deDescription: "Das historische Herz von Klatovy aus dem 13. Jahrhundert mit barocker Architektur, dem Weißen Turm und erhaltenen mittelalterlichen Befestigungen.",
  ...
  },
  {
    ...
    deName: "Gipfel Pancíř",
    deDescription: "Mit 1.214 m einer der bekanntesten Aussichtsgipfel der Šumava mit Berghütte und hölzernem Turm – bei klarem Wetter Blick bis zu den Alpen.",
  ...
  },
  {
    ...
    deName: "Teufelssee",
    deDescription: "Der zweitgrößte Gletschersee im Böhmer Wald unter der Felswand des Jezerní hora – nach einer Legende vom Teufel, der hier das Tal aushob.",
  ...
  },
  {
    ...
    deName: "Aussichtsturm Špičák",
    deDescription: "Auf dem Špičák (1.202 m) bietet dieser 26 m hohe Holzturm Panoramen über die grenzüberschreitende Region Šumava-Bayerischer Wald.",
  ...
  },
  {
    ...
    deName: "Wasserfall Weiße Schlucht",
    deDescription: "Der einzige natürliche Wasserfall im Nationalpark Šumava – der Bílý potok stürzt 14 m in eine Felsenschlucht, mit Holzplattform direkt über dem Wasser.",
  ...
  },
  {
    ...
    deName: "Klatower Katakomben",
    deDescription: "Eine Krypta unter der Jesuitenkirche – durch ein geniales Belüftungssystem sind Mumien aus dem 17. Jahrhundert erhalten geblieben.",
  ...
  },
  {
    ...
    deName: "Glas-Arche",
    deDescription: "Kunstinstallation na der bayerisch-tschechischen Grenze: ein grün leuchtendes Glasgefäß in Holzhänden – Symbol für Hoffnung und grenzüberschreitende Verbindung.",
